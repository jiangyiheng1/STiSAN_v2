...
def get_train_batch_next(batch, data_source, src_len, sampler, n_neg, processor, loc2gpscode):
...
def get_train_batch_multi(batch, data_source, src_len, sampler, n_neg, processor, loc2gpscode):
    src_seq, trg_seq = zip(*batch)
    src_user, src_loc, src_time, src_gpscode, src_lat, src_lon, src_data_size = [], [], [], [], [], [], []
    for e in src_seq:
        # u, l, g, t, lat, lon, b
